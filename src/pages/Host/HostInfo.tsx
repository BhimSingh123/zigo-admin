            ...
            <div className="row" style={{ padding: "20px" }}>
              ...
              >
                {loader === true ? (
                  ...
                  <img
                    src={getImageUrl(hostProfile?.image)}
                    className="img-fluid"
                    onError={(e: any) => {
                          ...
                          formatOptionLabel={(option) => (
                            <div className="d-flex align-items-center">
                              <img
                                ...
                                width={28}
                                alt={option.name}
                                src={getImageUrl(option.flagUrl)}
                                className="me-2"
                                style={{ objectFit: "cover" }}
                                onError={(e: any) => {
                ...
                <div className="row">
                  ...
                  {type1 === "fakeHost" && (
                    <div className="inputData col-12 mt-4">
                      ...
                      <div className={"host-video-preview-container mt-2"}>
                        {hostProfile?.liveVideo?.length &&
                          hostProfile?.liveVideo.map(
                    ...
                    {hostProfile?.profileVideo?.length > 0 && (
                      <div className="col-12">
                        <div className="inputData mt-4">
                          ...
                          <div className={"host-video-preview-container mt-2"}>
                            {hostProfile?.profileVideo?.length &&
                              hostProfile?.profileVideo.map(
                                (item: any, i: number) => {
                                  const finalUrl =
