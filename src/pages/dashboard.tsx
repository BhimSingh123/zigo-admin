...
const Dashboard = () => {
  ...
  const upperLoginType = String(loginType || "").toUpperCase();
  const isStaffLogin = upperLoginType === "STAFF" ;
    ...
    <div className="mainDashboard">
      <div className="dashBoardHead">
        ...
        <div className="row mb-0">
          ...
          <div className=" col-12 mb-0 d-flex justify-content-end">
            <Analytics
            ...
            >
              ...
              {loading.dashboardData ? (
                ...
                <DashBox
                  ...
                  onClick={
                    isStaffLogin ? undefined : () => router.push({ pathname: card.link })
                  }
...
const DashBox = ({ infoTooltip, dashSVG, title, amount, currency, coin, onClick, subtitle }: any) => {
  return (
    <Paper
      elevation={2}
      sx={{
    ...
    >
      ...
      <Tooltip title={infoTooltip} arrow placement="top-start">
        <IconButton
          sx={{ position: "absolute", top: 8, right: 8, padding: 0, color: "#8a4dff" }}
        >
          ...
          {amount !== undefined && (
            <>
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                ...
                <Typography variant="h6" sx={{ fontSize: 28, fontWeight: 600, marginTop: "2px" }}>
                  {amount}
                </Typography>
              </Box>
