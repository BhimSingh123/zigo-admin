...
// import Logo from "../assets/images/zigo_logo.png";
...
export default function Registration() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      try {
        await dispatch(signUpAdmin({payload: payload, userCredential: userCredential.user}));
      } catch (error) {
        ...
        <div className="d-flex flex-column justify-content-center align-items-center w-50 register-form">
          <div className="">
            <div className="logologin">
              <img src="/images/zigo_logo.png" alt="logo" className="w-100 h-100" />
            </div>
