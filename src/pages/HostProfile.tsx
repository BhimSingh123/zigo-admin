...
const HostProfile = () => {
  ...
  return (
    <>
      <div className="p-3">
        <Title name={`${hostData?.name ? hostData?.name : " "}'s   Profile`} />
              ...
              <div className="col-lg-10 col-md-6 col-12">
                  ...
                  <div className="col-md-4">
                    {loader === true ? (
                      ...
                      <ExInput
                        id={`uniqueId`}
                        name={`uniqueId`}
                        value={hostData?.uniqueId ? hostData?.uniqueId : ""}
                        label={`Unique Id`}
                ...
                <div className="row">
                  <div className="col-12">
                    {loader === true ? (
                      ...
                      <>
                        ...
                        <Textarea
                          row={5}
                          value={hostData?.bio !== "" ? hostData?.bio : "-"}
                          readOnly
                        />
                      </>
                    )}
                        ...
                        <div className="col-md-4">
                          {loader === true ? (
                            ...
                            <ExInput
                              id={`documentType`}
                              name={`documentType`}
                              value={hostData?.identityProofType || "-"}
                  ...
                  <div className="container inputData">
                    <label>
                      {hostData?.photoGallery?.length > 0 && "Host Album"}
                    </label>

                    {hostData?.photoGallery?.length > 0 && (
                      <div className="d-flex flex-wrap gap-3">
                        {hostData.photoGallery.map(
                          (url: string, index: number) => (
                            <div key={index}>
                              <img
                                src={getImageUrl(hostData?.image)}
                                className="img-fluid"
                                width={240}
                                height={260}
                                style={{
