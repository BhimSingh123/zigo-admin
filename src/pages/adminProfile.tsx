  ...
  return (
    <>
      <div className="mainAdminProfile">
        <Title name={isStaff ? "Staff profile" : "Admin profile"} />
        <div className="d-lg-flex d-md-block">
          ...
          <div
            className={
              isStaff
                ? "col-12 mt-4 pl-0"
                : "col-12 col-sm-12 col-md-12 col-lg-9 col-xxl-9 mt-4 pl-0"
            }
          >
            <div className="row">
                      ...
                      {roleSkeleton ? (
                        ...
                        <div
                          className={
                            isStaff
                              ? "col-12 my-3"
                              : "col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7 my-5"
                          }
                        >
                          {isStaff ? (
                            <>
