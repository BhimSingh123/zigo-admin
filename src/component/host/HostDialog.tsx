...
const HostDialog = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    const hasInvalidRates =
      !validateRateField(privateCallRate, "privateCallRate", "Private Call Rate") ||
      !validateRateField(
        randomCallFemaleRate,
        "randomCallFemaleRate",
        "Random Female Call Rate"
      ) ||
      !validateRateField(
        randomCallMaleRate,
        "randomCallMaleRate",
        "Random Male Call Rate"
      ) ||
      !validateRateField(randomCallRate, "randomCallRate", "Random Call Rate");
    ...
    if (
      ...
      if (hasInvalidRates) {
        if (!validateRateField(privateCallRate, "privateCallRate", "Private Call Rate")) {
          // already set inside
        }
        if (
          !validateRateField(
                ...
                <div className="row  formFooter mt-3">
                  ...
                  <div className="col-6">
                    <ExInput
                      ...
                      onChange={(e: any) => {
                        const value = e.target.value;
                        setPrivateCallRate(value);
                        validateRateField(value, "privateCallRate", "Private Call Rate");
                      }}
                    />
                  </div>
                  <div className="col-6">
