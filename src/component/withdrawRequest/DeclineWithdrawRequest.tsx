...
import CommonReasonDialog from "@/component/common/ReasonDialog";
...
const DeclineWithdrawRequest = (props: any) => {
  ...
  const handleChangeRowsPerPage = (event: any) => {
    changeRowsPerPage(parseInt(event, 10), totalDeclinedWithdrawal);
  };
  ...
  return (
    <>
      <div>
        {dialogueType === "reasonView" && <CommonReasonDialog />}
