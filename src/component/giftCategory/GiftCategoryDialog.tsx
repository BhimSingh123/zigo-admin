...
const GiftCategoryDialog = () => {
    ...
    const originalTitle = String(dialogueData?.name ?? "").trim();
    const currentTitle = String(title ?? "").trim();
    const hasChanges = !isEdit || currentTitle !== originalTitle;
    ...
    const handleSubmit = (e: any) => {
        ...
        if (!currentTitle) {
            ...
            error.title = "Gift Category is Required!";
            ...
            if (dialogueData) {
                ...
                dispatch(createGiftCategory(currentTitle as any));
            }
                                ...
                                <div className="row  formFooter mt-3">
                                    ...
                                    <div className="col-12 text-end m0">
                                        ...
                                        <Button
                                            ...
                                            disabled={!currentTitle || (isEdit && !hasChanges)}
                                        />
                                    </div>
                                </div>
                            </div>
