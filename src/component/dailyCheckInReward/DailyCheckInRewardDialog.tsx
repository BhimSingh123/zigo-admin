...
const DailyCheckInRewardDialog = () => {
    ...
    const originalDay = String(dialogueData?.day ?? "").trim();
    const originalDailyRewardCoin = String(dialogueData?.dailyRewardCoin ?? "").trim();
    const currentDay = String(day ?? "").trim();
    const currentDailyRewardCoin = String(dailyRewardCoin ?? "").trim();
    const hasChanges =
        !isEdit ||
        currentDay !== originalDay ||
        currentDailyRewardCoin !== originalDailyRewardCoin;
